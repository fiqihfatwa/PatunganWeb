            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    <div class="user-details">
                        ...
                        <div class="user-info">
                            <div class="dropdown">
                                <a href="<?=base_url('customer/profile')?>" class="dropdown-toggle">
                                    <?=$name?>
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            <li>
                                <a href="<?=base_url('customer/home')?>" class="waves-effect <?=$menu[0];?>"><i class="md md-home"></i><span> Beranda </span></a>
                            </li>
                            <li>
                                <a href="<?=base_url('customer/pengajuanproyek')?>" class="waves-effect <?=$menu[1];?>"><i class="md md-assignment"></i><span> Pengajuan Proyek </span></a>
                            </li>
                            <li>
                                <a href="<?=base_url('customer/projectsaya')?>" class="waves-effect <?=$menu[2];?>"><i class="md md-assignment-turned-in"></i><span> Proyek Saya </span></a>
                            </li>
                            <li>
                                <a href="<?=base_url('customer/timeline')?>" class="waves-effect <?=$menu[3];?>"><i class="md md-notifications"></i><span> Timeline </span><span class="badge badge-xs badge-danger">3</span></a>
                            </li>
                            <li>
